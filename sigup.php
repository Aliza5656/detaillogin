...
<div class="container-fluid bg-dark d-flex justify-content-center align-items-center " style="height: 100vh; width: 100%;">
    <div class="box bg-danger d-flex justify-content-center align-items-center  flex-column " style = "border-radius: 20px; padding: 20px; width: 500px; height: 500px;">
        ...
        <input type="radio" id="female" name="gender" value="female">
          ...
          <div class="form-link mt-2 text-end">
